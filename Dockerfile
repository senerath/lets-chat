...
ENV PKG_JSON_URL=https://raw.githubusercontent.com/senerath/lets-chat/master/package.json \
    TAR_GZ_URL=https://github.com/senerath/lets-chat/archive/master.tar.gz \
